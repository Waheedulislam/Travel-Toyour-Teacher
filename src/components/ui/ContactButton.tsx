  ...
  return (
    <Button
      className={cn(
        ...
        variant === 'orange' && "bg-gradient-to-r from-orange-500 to-yellow-300 hover:from-orange-600 hover:to-yellow-400 text-white border-none shadow-[4px_4px_0px_0px_rgba(255,140,0,0.7)]",
        // Size variations
